...
//if(isset($_POST['selected_category'])){ 
  ...
  $sql_catag_name = 'select * from think_blog_en  WHERE category1 = "'.$categoryname.'" OR category2 = "'.$categoryname.'" OR category3 = "'.$categoryname.'" OR category4 = "'.$categoryname.'" OR category5 = "'.$categoryname.'" OR category6 = "'.$categoryname.'" OR category7 = "'.$categoryname.'" OR category8 = "'.$categoryname.'" OR category9 = "'.$categoryname.'" OR category10 = "'.$categoryname.'" ORDER BY idx DESC';   
