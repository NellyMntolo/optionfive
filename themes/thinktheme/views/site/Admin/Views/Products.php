          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview menu-open active">
              ...
              <ul class="treeview-menu menu-open">
                ...
                <li><a href="/Admin/Products/"><i class="fa fa-edit text-lime"></i>Products</a></li>
...
<form action="/Admin/AllProducts" method="POST" enctype="multipart/form-data" accept-charset="utf-8">
