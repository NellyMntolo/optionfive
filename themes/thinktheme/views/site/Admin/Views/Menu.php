      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active"><a href="/Admin/Menu/"><i class="fa fa-reorder text-lime"></i><span>Menu</span></a></li>
...
<form action="/Admin/AllMenu" method="POST" enctype="multipart/form-data" accept-charset="utf-8">
          ...
          <div class="box box-success">
            ...
            <div class="box-body pad">                  
                    ...
                    <div class="form-group">
                      <label>Menu Text 1 EN</label>
                      <div class="input-group">
                      <div class="input-group-addon">
                        <i class="fa fa-book"></i>
                      </div>
                      <input type="tel" name="content_entext1" class="form-control" value="<?php echo $entext1 ?>" placeholder="Menu Text 1 EN">
                    </div><!-- /.input group -->                      
                    </div>

                    <div class="form-group">
                      <label>Menu Text 1 FR</label>
                      <div class="input-group">
                      <div class="input-group-addon">
                        <i class="fa fa-book"></i>
                      </div>
                      <input type="tel" name="content_zhtext1" class="form-control" value="<?php echo $zhtext1 ?>" placeholder="Menu Text 1 FR">
                    </div><!-- /.input group -->                      
                    </div>

                    <div class="form-group">
                      <label>Menu Text 2 EN</label>
                      <div class="input-group">
                      <div class="input-group-addon">
                        <i class="fa fa-television"></i>
                      </div>
                      <input type="tel" name="content_entext2" class="form-control" value="<?php echo $entext2 ?>" placeholder="Menu Text 2 EN">
                    </div><!-- /.input group -->                      
                    </div>

                    <div class="form-group">
                      <label>Menu Text 2 FR</label>
                      <div class="input-group">
                      <div class="input-group-addon">
                        <i class="fa fa-television"></i>
                      </div>
                      <input type="tel" name="content_zhtext2" class="form-control" value="<?php echo $zhtext2 ?>" placeholder="Menu Text 2 FR">
                    </div><!-- /.input group -->                      
                    </div>

                    <div class="form-group">
                      <label>Menu Text 3 EN</label>
                      <div class="input-group">
                      <div class="input-group-addon">
                        <i class="fa fa-magic"></i>
                      </div>
                      <input type="tel" name="content_entext3" class="form-control" value="<?php echo $entext3 ?>" placeholder="Menu Text 3 EN">
                    </div><!-- /.input group -->                      
                    </div>

                    <div class="form-group">
                      <label>Menu Text 3 FR</label>
                      <div class="input-group">
                      <div class="input-group-addon">
                        <i class="fa fa-magic"></i>
                      </div>
                      <input type="tel" name="content_zhtext3" class="form-control" value="<?php echo $zhtext3 ?>" placeholder="Menu Text 3 FR">
                    </div><!-- /.input group -->                      
                    </div>

                    <div class="form-group">
                      <label>Menu Text 4 EN</label>
                      <div class="input-group">
                      <div class="input-group-addon">
                        <i class="fa fa-meh-o"></i>
                      </div>
                      <input type="tel" name="content_entext4" class="form-control" value="<?php echo $entext4 ?>" placeholder="Menu Text 4 EN">
                    </div><!-- /.input group -->                      
                    </div>

                    <div class="form-group">
                      <label>Menu Text 4 FR</label>
                      <div class="input-group">
                      <div class="input-group-addon">
                        <i class="fa fa-meh-o"></i>
                      </div>
                      <input type="tel" name="content_zhtext4" class="form-control" value="<?php echo $zhtext4 ?>" placeholder="Menu Text 4 FR">
                    </div><!-- /.input group -->                      
                    </div>

                    <div class="form-group">
                      <label>Menu Text 5 EN</label>
                      <div class="input-group">
                      <div class="input-group-addon">
                        <i class="fa fa-microphone"></i>
                      </div>
                      <input type="tel" name="content_entext5" class="form-control" value="<?php echo $entext5 ?>" placeholder="Menu Text 5 EN">
                    </div><!-- /.input group -->                      
                    </div>

                    <div class="form-group">
                      <label>Menu Text 5 FR</label>
                      <div class="input-group">
                      <div class="input-group-addon">
                        <i class="fa fa-microphone"></i>
                      </div>
                      <input type="tel" name="content_zhtext5" class="form-control" value="<?php echo $zhtext5 ?>" placeholder="Menu Text 5 FR">
                    </div><!-- /.input group -->                      
                    </div>
