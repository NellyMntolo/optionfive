      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active"><a href="/Admin/Profile/"><i class="fa fa-user text-lime"></i><span>Profile</span></a></li>
          </ul><!-- /.sidebar-menu -->
        </section>
        <!-- /.sidebar -->
      </aside>
...
<!-- MODAL -->
    ...
    <script src="/themes/thinktheme/views/site/Admin/Assets/js/moment.js"></script>
