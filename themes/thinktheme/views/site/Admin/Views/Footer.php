      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active"><a href="/Admin/Footer/"><i class="fa fa-wheelchair text-lime"></i><span>Footer</span></a></li>
...
<form action="/Admin/AllFooter" method="POST" enctype="multipart/form-data" accept-charset="utf-8">

<!-- MODAL <button type="button" class="save-btn">Save All</button>-->
...
<!-- MODAL -->
          ...
          <div class="box box-success">
            ...
            <div class="box-body pad">                  
                    ...
                    <div class="form-group">
                      <label>Page Footer Tel: </label>
                      <div class="input-group">
                      <div class="input-group-addon">
                        <i class="fa fa-phone"></i>
                      </div>
                      <input type="tel" name="content_text1" class="form-control" value="<?php echo $entext1; ?>" placeholder="Page Footer Tel ">
                    </div><!-- /.input group -->                      
                    </div>


                    <div class="form-group">
                      <label>Page Footer Email: </label>
                      <div class="input-group">
                      <div class="input-group-addon">
                        <i class="fa fa-send"></i>
                      </div>
                      <input type="email" name="content_text2" class="form-control" value="<?php echo $entext2; ?>" placeholder="Page Footer Email ">
                    </div><!-- /.input group -->                      
                    </div>

                    <div class="form-group">
                      <label>Page Footer Description EN</label>
                      <div class="input-group">
                      <div class="input-group-addon">
                        <i class="fa fa-pencil"></i>
                      </div>
                      <textarea class="form-control" rows="3" name="content_entext3" placeholder="Page Footer Description EN"><?php echo $entext3; ?></textarea>
                    </div><!-- /.input group -->                      
                    </div>   

                    <div class="form-group">
                      <label>Page Footer Description FR</label>
                      <div class="input-group">
                      <div class="input-group-addon">
                        <i class="fa fa-pencil"></i>
                      </div>
                      <textarea class="form-control" rows="3" name="content_zhtext3" placeholder="Page Footer Description FR"><?php echo $zhtext3; ?></textarea>
                    </div><!-- /.input group -->                      
                    </div>  

                    <div class="form-group">
                      <button type="button" class="save-btn" style="position: relative;right: auto; margin-top: auto;height: auto;width: auto;" >Save All</button>     
                    </div>        
          ...
          <div class="box box-success">
            <div class="box-header">
              <h3 class="box-title"> Social Network Settings</h3>
                  <div class="pull-right box-tools">
                    <button class="btn btn-success btn-sm" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                    <!--<button class="btn btn-info btn-sm" data-widget="remove" data-toggle="tooltip" title="Remove"><i class="fa fa-times"></i></button>-->
                  </div><!-- /. tools -->
...
<form action="/Admin/AllFooter" method="POST" enctype="multipart/form-data" accept-charset="utf-8">
            <div class="row">
                    <div class="col-lg-4 form-group" style="width: 29%; float: left;">
                      <label>Icon <small>(55X55px)</small></label>
                    ...
                    <div class="col-lg-4 form-group" style="width: 29%; float: left;">
                      ...
                      <input style="height: 40px;" type="text" name="content_text4" class="form-control"  placeholder="http://www.example.com">
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="input-group">
                      ...
                      <select class="selectpicker" name="content_text5" id="form-select">                        
                    ...
                    <div class="col-lg-4 form-group" style="width: 90%; float: left;">
                      <input class="btn-success extra-btn" type="submit" value="Add Item" name="add_social"> 
                    </div>
            </div>
</form>
                    <?php while($rowsocial = mysql_fetch_array($retvalsocial, MYSQL_ASSOC)){
                            $idx = $rowsocial['idx'];
                            $zhtext1 = $rowsocial['text1'];     
                            $zhtext2 = $rowsocial['text2']; 
                            $image = $rowsocial['image1']; 

                            $window = '';

                            if ($zhtext2 == "_blank") {
                              $window = '<option value="'.$zhtext2.'">New Window</option><option value="_self">Same Window</option>';
                              # code...
                            } else {
                              $window = '<option value="'.$zhtext2.'">Same Window</option><option value="_blank">New Window</option>';
                            }

                    echo '<form action="/Admin/AllFooter" method="POST" enctype="multipart/form-data" accept-charset="utf-8">
                            ...
                            <div class="form-group" style="width: 29%; float: left;">
                              ...
                              <input style="height: 40px;" type="text" name="content_text4" class="form-control"  value="'.$zhtext1.'">
                            </div><!-- /.input group -->                      
                            </div>
                            ...
                            <input type="hidden" value="'.$idx.'" name="social_id">
                            <div class="form-group" style="width: 90%; float: left;">
                              <input class="btn-success extra-btn" type="submit" value="Edit Item" name="edit_social">
                              <input class="btn-danger extra-btn" type="submit" value="Delete Item" name="delete_social">
                            </div>
                            </form>';
