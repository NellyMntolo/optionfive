          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview menu-open active">
              ...
              <ul class="treeview-menu menu-open">
                ...
                <li><a href="/Admin/Retailers/"><i class="fa fa-edit text-lime"></i>Retailers</a></li>                
              </ul>
            </li>
            <li class="treeview">
...
<form action="/Admin/AllRetailers" method="POST" enctype="multipart/form-data" accept-charset="utf-8">
          ...
          <div class="box box-success">
            ...
            <div class="box-body pad">
                    ...
                    <div class="form-group" style="width: 95%;">
                      ...
                      <input type="file" id="pagemainimage" name="wedo_image1">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="general_entext4" class="form-control"  value="<?php echo $entext4;?>" placeholder="Slogan EN">
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="general_zhtext4" class="form-control"  value="<?php echo $zhtext4;?>" placeholder="Slogan FR">
                    </div><!-- /.input group -->                      
                    </div>  
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext1" class="form-control" value="<?php echo $entext5;?>" placeholder="Page Text EN">
                    </div><!-- /.input group -->                         
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_zhtext1" class="form-control" value="<?php echo $zhtext5;?>" placeholder="Page Text FR">
                    </div><!-- /.input group -->                       
                    </div>

                    <div class="form-group" style="width: 95%;">
                      <label>Page Image</label>
                      <input type="file" id="pagemainimage" name="wedo_image2">
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" rows="3" name="content_entext2" placeholder="Page Text Description EN"><?php echo $entext6;?></textarea>
                    </div><!-- /.input group -->                       
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" rows="3" name="content_zhtext2" placeholder="Page Text Description FR"><?php echo $zhtext6;?></textarea>
                    </div><!-- /.input group -->                       
                    </div>
                    ...
                    <div class="form-group" style="width: 95%;">
                      <label>Page Image</label>
                      <input type="file" id="pagemainimage" name="wedo_image3">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext3" class="form-control" value="<?php echo $entext7;?>" placeholder="Page Text EN">
                    </div><!-- /.input group -->                         
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_zhtext3" class="form-control" value="<?php echo $zhtext7;?>" placeholder="Page Text FR">
                    </div><!-- /.input group -->                       
                    </div>
