<?php
include '../Model/editprojectDAO.php';
          ...
          <div class="box box-success">
            ...
            <div class="box-body pad">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="general_entext1" class="form-control" placeholder="Page Title EN" value="<?php echo $entext1; ?>">
                    </div><!-- /.input group -->                       
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="general_zhtext1" class="form-control" placeholder="Page Title FR" value="<?php echo $zhtext1; ?>">
                    </div><!-- /.input group -->                       
                    </div>
