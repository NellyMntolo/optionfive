          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview menu-open active">
              ...
              <ul class="treeview-menu menu-open">
                ...
                <li><a href="/Admin/About/"><i class="fa fa-edit text-lime"></i>About</a></li>                
          ...
          <div class="box box-success">
            ...
            <div class="box-body pad">  
                    ...
                    <div class="form-group">
                      ...
                      <textarea rows="3" name="content_entext2" class="form-control" placeholder="Page Description EN"><?php echo $entext6; ?></textarea>
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <textarea rows="3" name="content_zhtext2" class="form-control" placeholder="Page Description FR"><?php echo $zhtext6; ?></textarea>
                    </div><!-- /.input group -->                      
                    </div>

                    <div class="form-group" style="width: 95%;">
                      <label>Page Main Image</label>
                      <input type="file" id="pagemainimage" name="weare_image1">
