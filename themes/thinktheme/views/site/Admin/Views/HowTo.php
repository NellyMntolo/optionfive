...
<html>
  <head>
    ...
    <script src="/themes/thinktheme/views/site/ckeditor/ckeditor.js"></script>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview menu-open active">
              ...
              <ul class="treeview-menu menu-open">
                ...
                <li><a href="/Admin/HowTo/"><i class="fa fa-edit text-lime"></i>How To</a></li>
...
<form action="/Admin/AllHowTo" method="POST" enctype="multipart/form-data" accept-charset="utf-8">
...
<!-- General Settings -->
          <div class="box box-info">
            ...
            <div class="box-body pad">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="general_entext1" class="form-control" value="<?php echo $entext1;?>" placeholder="Page Title EN">
                    </div><!-- /.input group -->                       
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="general_zhtext1" class="form-control" value="<?php echo $zhtext1;?>" placeholder="Page Title FR">
                    </div><!-- /.input group -->                       
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" rows="3" name="general_entext2" placeholder="Page Keywords EN"><?php echo $entext2;?></textarea>
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" rows="3" name="general_zhtext2" placeholder="Page Keywords FR"><?php echo $zhtext2;?></textarea>
                    </div><!-- /.input group -->
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" rows="3" name="general_entext3" placeholder="Page Description EN"><?php echo $entext3;?></textarea>
                    </div><!-- /.input group -->                      
                    </div>

                    <div class="form-group">
                      <label>Page Description FR</label>
                      <div class="input-group">
                      <div class="input-group-addon">
                        <i class="fa fa-keyboard-o text-aqua"></i>
                      </div>
                      <textarea class="form-control" rows="3" name="general_zhtext3" placeholder="Page Description FR"><?php echo $zhtext3;?></textarea>
                    </div><!-- /.input group -->                      
                    </div>

                    <div class="form-group" style="opacity: 0;">
                      <label>Page Menu Slogan EN</label>
                      <div class="input-group">
                      <div class="input-group-addon">
                        <i class="fa fa-pencil-square-o text-aqua"></i>
                      </div>
                      <input type="text" name="general_entext4" class="form-control"  value="<?php echo $entext4;?>" placeholder="Page Menu Slogan EN">
                    </div><!-- /.input group -->                      
                    </div>

                    <div class="form-group" style="opacity: 0;">
                      <label>Page Menu Slogan FR</label>
                      <div class="input-group">
                      <div class="input-group-addon">
                        <i class="fa fa-pencil-square-o text-aqua"></i>
                      </div>
                      <input type="text" name="general_zhtext4" class="form-control"  value="<?php echo $zhtext4;?>" placeholder="Page Menu Slogan FR">
                    </div><!-- /.input group -->                      
                    </div>  
          ...
          <div class="box box-success">
            ...
            <div class="box-body pad">                  
                    ...
                    <div class="form-group">
                      <label>Page Slogan EN</label>
                      <div class="input-group">
                      <div class="input-group-addon">
                        <i class="fa fa-pencil-square-o"></i>
                      </div>
                      <input type="text" name="content_entext1" class="form-control" value="<?php echo $entext5;?>" placeholder="Page Slogan EN">
                    </div><!-- /.input group -->                         
                    </div>

                    <div class="form-group">
                      <label>Page Slogan FR</label>
                      <div class="input-group">
                      <div class="input-group-addon">
                        <i class="fa fa-pencil-square-o"></i>
                      </div>
                      <input type="text" name="content_zhtext1" class="form-control" value="<?php echo $zhtext5;?>" placeholder="Page Slogan FR">
                    </div><!-- /.input group -->                       
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" rows="3" name="content_entext2" placeholder="Page Description EN"><?php echo $entext6;?></textarea>
                    </div><!-- /.input group -->                       
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" rows="3" name="content_zhtext2" placeholder="Page Description FR"><?php echo $zhtext6;?></textarea>
                    </div><!-- /.input group -->                       
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" id="howto_text" rows="3" name="content_entext3" placeholder="Page Description EN"></textarea>
                    </div><!-- /.input group -->                       
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" id="howto_textzh" rows="3" name="content_zhtext3" placeholder="Page Description FR"></textarea>
                    </div><!-- /.input group -->                       
                    </div>


                    <script type="text/javascript">
                      CKEDITOR.replace( 'howto_text' );
                      CKEDITOR.replace( 'howto_textzh' );
                  </script>

                <?php echo "<script>CKEDITOR.instances.howto_text.setData('".mysql_real_escape_string($entext7, $conn)."')</script>"; ?>
                <?php echo "<script>CKEDITOR.instances.howto_textzh.setData('".mysql_real_escape_string($zhtext7, $conn)."')</script>"; ?>
                </div><!-- box-body -->
