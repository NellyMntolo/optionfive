...
if(isset($_POST['page_submit'])){
  ...
  $image1 = $_FILES['weare_image1']['name'];


 $sql="UPDATE think_weare_en SET text1='".$entext1."', text2='".$entext2."', text3='".$entext3."', text4='".$entext4."', text5='".$entext5."', text6='".$entext6."' ";              
 ...
 $sqlzh="UPDATE think_weare_zh SET text1='".$zhtext1."', text2='".$zhtext2."', text3='".$zhtext3."', text4='".$zhtext4."', text5='".$zhtext5."', text6='".$zhtext6."' ";              
    ...
    if($image1 != null) {
      $weare_image1 = addslashes(file_get_contents($_FILES['weare_image1']['tmp_name']));
      $file_tmp1 =$_FILES['weare_image1']['tmp_name'];
      move_uploaded_file($file_tmp1, getcwd()."/../../../../../../uploads/".$image1);
      $filename = "/uploads/".$image1;
      $sql1="UPDATE think_weare_en SET image1='".$filename."'";
      $retval1 = mysql_query( $sql1, $conn );
                   if(! $retval1 )
                       {
                          die('Could not enter image: ' . mysql_error());
                       }
      $sql2="UPDATE think_weare_zh SET image1='".$filename."'";
