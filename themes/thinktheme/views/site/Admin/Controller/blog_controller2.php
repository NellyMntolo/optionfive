...
if(isset($_POST['create_blog_submit'])){
  ...
  $image12 = $_FILES['blog_image12']['name'];
  $image13 = $_FILES['blog_image13']['name'];
  $image14 = $_FILES['blog_image14']['name'];
  $image15 = $_FILES['blog_image15']['name'];
  ...
  $sqlb = 'INSERT INTO think_blog_zh (text1, text2, text3, text4, text5, text6, text7, text8, text9, text10, text11, text12, text13, text14, text15, text16, text17, image1, image2, image3, image4, image5, image6, image7, image8, image9, image10, image11, image12, image13, image14, image15, publish, send_to_index, category1, sortable_order) VALUES ( "'.$zhtext1.'", "'.$zhtext2.'", "'.$zhtext3.'", "'.$zhtext4.'", "'.$zhtext5.'", "'.$zhtext6.'", "'.$zhtext7.'", "'.$zhtext8.'", "'.$zhtext9.'", "'.$zhtext10.'", "'.$zhtext11.'","'.$zhtext12.'","'.$zhtext13.'","'.$zhtext14.'","'.$zhtext15.'","'.$zhtext16.'","'.$zhtext17.'","'.$uploaded_image1.'","'.$uploaded_image2.'","'.$uploaded_image3.'","'.$uploaded_image4.'","'.$uploaded_image5.'","'.$uploaded_image6.'","'.$uploaded_image7.'","'.$uploaded_image8.'","'.$uploaded_image9.'","'.$uploaded_image10.'","'.$uploaded_image11.'","'.$uploaded_image12.'","'.$uploaded_image13.'","'.$uploaded_image14.'","'.$uploaded_image15.'","'.$publish.'","'.$send_to_index.'","'.$category_zh.'","'.$large.'"+1)';
...
if(isset($_POST['edit_blog_submit'])){
  ...
  $publish = mysql_real_escape_string($_POST['publish'],$conn);
  $send_to_index = mysql_real_escape_string($_POST['send_to_index'],$conn);
  /*$zhimage1 = $_FILES['blog_image1']['name'];
  $zhimage2 = $_FILES['blog_image2']['name'];
  $zhimage3 = $_FILES['blog_image3']['name'];
  $zhimage4 = $_FILES['blog_image4']['name'];
  $zhimage5 = $_FILES['blog_image5']['name'];
  $zhimage6 = $_FILES['blog_image6']['name'];
  $zhimage7 = $_FILES['blog_image7']['name'];
  $zhimage8 = $_FILES['blog_image8']['name'];
  $zhimage9 = $_FILES['blog_image9']['name'];
  $zhimage10 = $_FILES['blog_image10']['name'];
  $zhimage11 = $_FILES['blog_image11']['name'];
  $zhimage12 = $_FILES['blog_image12']['name'];
  $zhimage13 = $_FILES['blog_image13']['name'];
  $zhimage14 = $_FILES['blog_image14']['name'];
  $zhimage15 = $_FILES['blog_image15']['name'];*/
 ...
 $sqlzh="UPDATE think_blog_zh SET text1='".$zhtext1."', text2='".$zhtext2."', text3='".$zhtext3."', text4='".$zhtext4."', text5='".$zhtext5."', text6='".$zhtext6."', text7='".$zhtext7."', text8='".$zhtext8."', text9='".$zhtext9."', text10='".$zhtext10."', text11='".$zhtext11."', text12='".$zhtext12."', text13='".$zhtext13."', text14='".$zhtext14."', text15='".$zhtext15."', text16='".$zhtext16."', text17='".$zhtext17."', publish='".$publish."', send_to_index='".$send_to_index."' WHERE idx='".$blogid."' LIMIT 1 ";              
    ...
    if($image12 != null) {
      $file_tmp1 =$_FILES['blog_image12']['tmp_name'];
      move_uploaded_file($file_tmp1, getcwd()."/../../../../../../uploads/".$image12);
      $filename = "/uploads/".$image12;
      $sql1="UPDATE think_blog_en SET image12='".$filename."' WHERE idx ='".$blogid."'";
      $retval1 = mysql_query( $sql1, $conn );
                   if(! $retval1 )
                       {
                          die('Could not enter image: ' . mysql_error());
                       }
      $sql12="UPDATE think_blog_zh SET image12='".$filename."' WHERE idx ='".$blogid."'";
    ...
    if($image13 != null) {
      $file_tmp1 =$_FILES['blog_image13']['tmp_name'];
      move_uploaded_file($file_tmp1, getcwd()."/../../../../../../uploads/".$image13);
      $filename = "/uploads/".$image13;
      $sql1="UPDATE think_blog_en SET image13='".$filename."' WHERE idx ='".$blogid."'";
      $retval1 = mysql_query( $sql1, $conn );
                   if(! $retval1 )
                       {
                          die('Could not enter image: ' . mysql_error());
                       }
      $sql13="UPDATE think_blog_zh SET image13='".$filename."' WHERE idx ='".$blogid."'";
    ...
    if($image14 != null) {
      $file_tmp1 =$_FILES['blog_image14']['tmp_name'];
      move_uploaded_file($file_tmp1, getcwd()."/../../../../../../uploads/".$image14);
      $filename = "/uploads/".$image14;
      $sql1="UPDATE think_blog_en SET image14='".$filename."' WHERE idx ='".$blogid."'";
      $retval1 = mysql_query( $sql1, $conn );
                   if(! $retval1 )
                       {
                          die('Could not enter image: ' . mysql_error());
                       }
      $sql14="UPDATE think_blog_zh SET image14='".$filename."' WHERE idx ='".$blogid."'";
    ...
    if($image15 != null) {
      $file_tmp1 =$_FILES['blog_image15']['tmp_name'];
      move_uploaded_file($file_tmp1, getcwd()."/../../../../../../uploads/".$image15);
      $filename = "/uploads/".$image15;
      $sql1="UPDATE think_blog_en SET image15='".$filename."' WHERE idx ='".$blogid."'";
      $retval1 = mysql_query( $sql1, $conn );
                   if(! $retval1 )
                       {
                          die('Could not enter image: ' . mysql_error());
                       }
      $sql15="UPDATE think_blog_zh SET image15='".$filename."' WHERE idx ='".$blogid."'";
