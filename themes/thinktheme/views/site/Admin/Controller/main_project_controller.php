...
if(isset($_POST['page_submit'])){
 ...
 $sql="UPDATE think_main_project_en SET text1='".$entext1."', text2='".$entext2."', text3='".$entext3."', text4='".$entext4."', text5='".$entext5."', text6='".$entext6."', text7='".$entext7."' ";              
 ...
 $sqlzh="UPDATE think_main_project_zh SET text1='".$zhtext1."', text2='".$zhtext2."', text3='".$zhtext3."', text4='".$zhtext4."', text5='".$zhtext5."', text6='".$zhtext6."', text7='".$zhtext7."' ";              
    ...
    if($image1 != null) {
      ...
      $sql1="UPDATE think_main_project_en SET image1='".$filename."'";
      $retval1 = mysql_query( $sql1, $conn );
                   if(! $retval1 )
                       {
                          die('Could not enter image: ' . mysql_error());
                       }
      $sql2="UPDATE think_main_project_zh SET image1='".$filename."'";
      $retval2 = mysql_query( $sql2, $conn );
                   if(! $retval2 )
                      ...
                      header("Refresh:0; url=/Admin/HowTo/");
}
