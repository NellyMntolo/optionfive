...
<meta name="description" content="<?php echo $lang['main_project_text3']; ?>">
<meta name="keywords" content="<?php echo $lang['main_project_text2']; ?>">
...
<title><?php echo $lang['main_project_text1']; ?></title>
</head>
<body>
...
<nav>
    <ul class="menu menu-move menu--prospero" id="menu">
        ...
        <div class="cd-main-nav-links">
            <li class="menu__item-active menu-fix1"><a href="/HowTo" class="menu__link"><?php echo $lang['menu_text1'];?></a></li>
...
<section id="section1" class="cd-intro video cd-section"  style="background-image:url(/themes/thinktheme/views/site/assets/images/Option5Contact.jpg)!important";>
	<div class="cd-section-content">
        <h1><?php echo $lang['main_project_text5']; ?></h1>
        <p><?php echo $lang['main_project_text6']; ?></p>
    </div>
...
<?php echo $lang['main_project_text7']; ?>
