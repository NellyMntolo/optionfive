...
<meta name="description" content="<?php echo $lang['contact_text3']; ?>">
<meta name="keywords" content="<?php echo $lang['contact_text2']; ?>">
...
<title><?php echo $lang['contact_text1']; ?></title>
</head>
<body>
<!-- Modal -->
...
<nav>
    <ul class="menu menu-move menu--prospero" id="menu">
        ...
        <div class="cd-main-nav-links">
            ...
            <li class="menu__item-active"><a href="/Contact" class="menu__link"><?php echo $lang['menu_text3'];?></a></li>
            <li class="menu__item"><a href="/About" class="menu__link"><?php echo $lang['menu_text4'];?></a></li>
            <li class="menu__item"><a href="/Retailers" class="menu__link"><?php echo $lang['menu_text5'];?></a></li>
        </div>
    </ul>
</nav>
...
<section id="section1" class="cd-section" style="background-image:url(<?php echo $lang['contact_image1']; ?>)!important;">
	<div class="cd-section-content">
        <h1><?php echo $lang['contact_text4']; ?></h1>
        <p class="hidden-xxs">
        </p>
    </div>
    	...
    	<div class="thnk-container thnk-restrict">
        	<div class="thnk-talk">                
                <div class="contact-wrapper">
                    <h1><?php echo $lang['contact_text5']; ?></h1>
                    <form action="/Contact_Success" method="POST">    
                    <div class="input-top">
