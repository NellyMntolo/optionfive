...
<meta name="description" content="<?php echo $lang['product_text2']; ?>">
<meta name="keywords" content="<?php echo $lang['product_text2']; ?>">
...
<title><?php echo $lang['product_text1']; ?></title>
</head>
<body>
...
<nav>
    <ul class="menu menu-move menu--prospero" id="menu">
        ...
        <div class="cd-main-nav-links">
            ...
            <li class="menu__item-active "><a href="/Products" class="menu__link"><?php echo $lang['menu_text2'];?></a></li>
...
<section id="section1" class="cd-intro video cd-section">
	...
	<div class="cd-intro-content video">
		<h1 class="svg-wrapper">
         ...
         <div class="cd-bg-video-wrapper" style="background-image:url(/themes/thinktheme/views/site/assets/video/bg-img1.jpg);" data-video="<?php echo $lang['product_image1']; ?>">
...
<section id="section2" class="cd-section2 animation-element bounce-up">
    <div class="thnk-wrapper subject bg-color1">
    	<div class="thnk-container thnk-restrict">
        	<div class="thnk-talk">
        		<h1 class="alt"><?php echo $lang['product_text5']; ?></h1>
                ...
                <img src="/themes/thinktheme/views/site/assets/images/how1.png"/>
                <p><?php echo $lang['product_text6']; ?></p>
            </div>
        </div>
    </div>
</section><!-- cd-section -->

<?php echo $lang['wecreate_projects']; ?>
