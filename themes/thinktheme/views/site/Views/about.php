...
<meta name="description" content="<?php echo $lang['weare_text3']; ?>">
<meta name="keywords" content="<?php echo $lang['weare_text2']; ?>">
...
<title><?php echo $lang['weare_text1']; ?></title>
</head>
<body>
...
<nav>
    <ul class="menu menu-move menu--prospero" id="menu">
        ...
        <div class="cd-main-nav-links">
            ...
            <li class="menu__item-active"><a href="/About" class="menu__link"><?php echo $lang['menu_text4'];?></a></li>
...
<section id="section1" class="cd-section" style="background-image:url(<?php echo $lang['weare_image1']; ?>)!important;">
	<div class="cd-section-content">
        <h1><?php echo $lang['weare_text4']; ?></h1>
        <p class="hidden-xxs">
        </p>
    </div>
...
<section id="section2" class="cd-section2 animation-element bounce-up">
    <div class="thnk-wrapper bg-color1 subject">
    	<div class="thnk-container thnk-restrict">
        	<div class="thnk-talk">
        		<h1 class="alt"><?php echo $lang['weare_text5']; ?></h1>
