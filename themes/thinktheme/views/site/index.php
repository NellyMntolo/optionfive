...
<nav>
    <ul class="menu menu-move menu--prospero" id="menu">
        ...
        <div class="cd-main-nav-links">
            <li class="menu__item menu-fix1"><a href="/HowTo" class="menu__link"><?php echo $lang['menu_text1'];?></a></li>
            <li class="menu__item menu-fix2"><a href="/Products" class="menu__link"><?php echo $lang['menu_text2'];?></a></li>
            <li class="menu__item menu-fix3"><a href="/Contact" class="menu__link"><?php echo $lang['menu_text3'];?></a></li>
            <li class="menu__item menu-fix4"><a href="/About" class="menu__link"><?php echo $lang['menu_text4'];?></a></li>
            <li class="menu__item menu-fix5"><a href="/Retailers" class="menu__link"><?php echo $lang['menu_text5'];?></a></li>
        </div>
    </ul>
</nav>
...
<section id="section1" class="cd-intro video cd-section">
	<div class="cd-section-content">
    <h1><?php echo $lang['index_text5']; ?></h1>
    <p><?php echo $lang['index_text6']; ?></p>
    </div>
	...
	<div class="cd-intro-content video">
		<h1 class="svg-wrapper">
            <svg class="svg-mask"  version="1.1"
                 xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:a="http://ns.adobe.com/AdobeSVGViewerExtensions/3.0/"
                 x="0px" y="0px" width="4000px" height="4000px" viewBox="0 0 4000 4000" style="enable-background:new 0 0 4000 4000;"
                 xml:space="preserve">
            <style type="text/css">
                .st0{fill:rgba(0,0,0,0.4);}
            </style>
            <path class="st0" d="M0,0v4000h4000V0H0z"/>
            </svg>
            
            <svg class="svg-mask-mobile"  version="1.1"
                 xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:a="http://ns.adobe.com/AdobeSVGViewerExtensions/3.0/"
                 x="0px" y="0px" width="4000px" height="3000px" viewBox="0 0 4000 3000" style="enable-background:new 0 0 4000 3000;"
                 xml:space="preserve">
            <style type="text/css">
                .st0{fill:rgba(0,0,0,0.4);}
            </style>
            <path class="st0" d="M0,0v4000h3000V0H0z"/>
            </svg>
	    </h1>
         <div class="cd-bg-video-wrapper-small" style="background-image:url(/themes/thinktheme/views/site/assets/video/bg-img1.jpg);"></div>
         <div class="cd-bg-video-wrapper" style="background-image:url(/themes/thinktheme/views/site/assets/video/bg-img1.jpg);" data-video="<?php echo $lang['index_image1']; ?>">
...
<section id="section2" class="cd-section2 animation-element bounce-up">
    <div class="thnk-wrapper subject bg-color1">
    	<div class="thnk-container thnk-restrict">
        	<div class="thnk-talk">
        		<h1 class="alt"><?php echo $lang['index_text7']; ?></h1>
...
<section id="section3" class="cd-section2 animation-element bounce-up">
 	<div class="thnk-wrapper bg-color1 subject">
        <div class="we-logo">
            <img src="<?php echo $lang['index_image2']; ?>"/>
        </div>
    </div>
</section><!-- cd-section -->
<section id="section2" class="cd-section2 animation-element bounce-up">
...
<section id="section3" class="thnk-wrapper animation-element bounce-up">
 	<div class="thnk-wrapper subject">
    	<div class="thnk-container">
            <div class="testimonial">
                <div class="test-item">
                    <div class="test-item-img">
                        <img src="/themes/thinktheme/views/site/assets/images/Option-5-logo.jpg"/>
                    </div>
                    <div class="test-item-content">
                        <h3><?php echo $lang['index_text11']; ?></h3>
                ...
                <div class="test-item">
                    ...
                    <div class="test-item-content">
                        <h3><?php echo $lang['index_text13']; ?></h3>
                ...
                <div class="test-item">
                    ...
                    <div class="test-item-content">
                        <h3><?php echo $lang['index_text15']; ?></h3>
...
<section id="section2" class="thnk-wrapper animation-element bounce-up">
    <div class="thnk-wrapper subject bg-color1">
    	<div class="thnk-container thnk-restrict">
        	<div class="thnk-talk">
        		<h1 class="alt"><?php echo $lang['index_text17']; ?></h1>
                <div class="thnk-wrapper">
                    <div class="thnk-talk-dots animation-element bounce-updot">
                        <div class="thnk-talk-dots animation-element bounce-updot">
                        <div class="thnk-talk-dot thnk-talk-dot-rotate subject"></div>
...
<section id="section3" class="cd-section2 animation-element bounce-up">
 	<div class="thnk-wrapper bg-color1 subject">
        <div class="we-logo">
            <img src="<?php echo $lang['index_image3']; ?>"/>
        </div>
    </div>
</section><!-- cd-section -->
<section id="section2" class="thnk-wrapper animation-element bounce-up">
    <div class="thnk-wrapper subject">
    	<div class="thnk-container thnk-restrict">
        	<div class="thnk-talk">
            	<div class="thnk-wrapper">
        			<h1 class="alt"><?php echo $lang['index_text19']; ?></h1>
                </div>
                <div class="thnk-wrapper">
                    <div class="thnk-talk-dots animation-element bounce-updot">
                        <div class="thnk-talk-dots animation-element bounce-updot">
                ...
                <p><?php echo $lang['index_text20']; ?></p>
                <button class="btn btn-primary" onclick="window.location='/Contact';">Contact us</button>
            </div>
        </div>
    </div>
</section><!-- cd-section -->
